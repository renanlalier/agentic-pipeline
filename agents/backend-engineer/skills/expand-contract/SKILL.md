...
description: Use esta skill sempre que a mudanca tocar um contrato consumido por outro repositorio (rota, payload, status code, evento), independente da stack. Detalha como aplicar expand/contract em vez de breaking change.
---

# Expand/contract em mudança de contrato

Esta skill é agnóstica de stack.
